...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Nishi voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
if (conf.LANG == 'EN') {
    ...
    already_on = 'Nishi artificial intelligence is already fully functional.'
    already_off = 'Nishi artificial intelligence is currently running semi-functional.'
    succ_on = 'Nishi Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Nishi Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
